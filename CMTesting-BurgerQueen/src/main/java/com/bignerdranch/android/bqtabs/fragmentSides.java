...
public class fragmentSides extends Fragment {
    ...
    public fragmentSides() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.sides_fragment,container,false);
        myrecyclerview = v.findViewById(R.id.sides_recyclerview);
        mMenuInventory = MenuInventory.get(getActivity());
        lstItem = mMenuInventory.getCategoryMenuItems("Sides");
